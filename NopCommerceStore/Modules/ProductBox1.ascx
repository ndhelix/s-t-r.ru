...
<div class="product-item">
    ...
    <div class="add-info">
        <div class="prices">
            <asp:Label ID="lblOldPrice" runat="server" visible=false CssClass="oldproductPrice" />
            <br />
            <asp:Label ID="lblPrice" visible=false runat="server" CssClass="productPrice" /></div>
        <div class="buttons">
            ...
            <asp:Button runat="server" ID="btnAddToCart" OnCommand="btnAddToCart_Click" Text="<% $NopResources:Products.AddToCart %>"
                ValidationGroup="ProductDetails" CommandArgument='<%# Eval("ProductId") %>' CssClass="productgridaddtocartbutton" visible=false />
        </div>
    </div>
</div>
