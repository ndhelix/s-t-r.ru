...
<div class="homepage">
    ...
    <div class="options">
        <ul>
            ...
            <li>
                <div class="title">
                    <a href="YandexMarket.aspx" title="<%=GetLocaleResourceString("Admin.PromotionProvidersHome.YandexMarket.TitleDescription")%>">
                        <%=GetLocaleResourceString("Admin.PromotionProvidersHome.YandexMarket.Title")%></a>
                </div>
                <div class="description">
                    <p>
                        <%=GetLocaleResourceString("Admin.PromotionProvidersHome.YandexMarket.Description")%>
                    </p>
                </div>
            </li>
        </ul>
